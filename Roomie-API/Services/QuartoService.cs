...
public class QuartoService : ServiceBase<QuartoDTO, Quarto>, IQuartoService
{
    private IMapper _mapper;
    private IQuartoRepository _repository;
    public QuartoService(IQuartoRepository repository, IMapper mapper) : base(repository, mapper)
    {
        _mapper = mapper;
